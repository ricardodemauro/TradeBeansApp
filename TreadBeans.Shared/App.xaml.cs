...
using TreadBeans.Services;

#if WINDOWS_APP
using Windows.System;
using Windows.UI.Core;
using Windows.UI.ApplicationSettings;
using TreadBeans.AppFlyouts;
#endif
...
namespace TreadBeans
{
    ...
    {
        private Guid APP_ID = new Guid("4f8c5fc2-7c8e-4561-9730-0f47dea72222");
        public const string APP_NAME = "TreadBeans";
        ...
        private void UpdateAppTiles()
        {
            ...
            {
                TileServices.CreateFlipTile(@"Catalog", @"");
